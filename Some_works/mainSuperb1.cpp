...
public:
    MainWindow() {
        ...
        left_box->set_size_request(200, -1); // Fixed minimum width for the left pane
        ...
        Gtk::Alignment* alignment = Gtk::make_managed<Gtk::Alignment>(0.5, 0.5, 0.0, 0.0); // Center alignment
        ...
        // Set minimum width for the right pane
        ...
        alignment->add(*right_box);
        paned->add2(*alignment);
